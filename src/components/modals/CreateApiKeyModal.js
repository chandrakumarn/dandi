    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md flex flex-col items-center border border-gray-200 max-h-[90vh] overflow-y-auto">
        <div className="w-full">
          <h2 className="text-xl sm:text-2xl font-bold mb-2 text-center text-gray-900">Create a new API key</h2>
          <p className="text-gray-600 text-center mb-6 text-sm sm:text-base">Enter a name and limit for the new API key.</p>
          <form
          ...
          >
            ...
            <div>
              <label className="flex items-center gap-3 text-sm font-medium text-gray-700">
                ...
                />
                <span className="text-sm sm:text-base">Limit monthly usage*</span>
              </label>
              <input
                type="number"
                min="1"
                className="w-full mt-3 rounded-xl border border-gray-300 px-4 py-3 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 disabled:opacity-50 text-sm sm:text-base"
                value={limit}
